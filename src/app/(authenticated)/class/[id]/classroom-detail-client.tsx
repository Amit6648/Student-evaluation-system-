...
export default function ClassroomDetailPageClient({ currentUser, classId }: { currentUser: CurrentUser; classId: string }) {
    ...
    return (
        <div className="min-h-screen p-8 max-w-7xl mx-auto relative pl-12 border-l-[4px] border-[#0088FF] shadow-[inset_1px_0_0_rgba(0,0,0,0.05)]">
            <Link href="/" className="inline-flex items-center text-[#111827]/70 hover:text-[#0088FF] mb-8 font-bold transition-colors">
                    ...
                    <div className="space-y-6">
                        ...
                        {exportMode === 'average' && (
                            <div className="space-y-2 animate-in fade-in slide-in-from-top-2 bg-[#F0F4F8] p-4 rounded-2xl border border-[#111827]/5">
                                <label className="text-center text-[10px] font-black tracking-widest text-[#111827]/50 uppercase block mb-2">Extract Highest 'N' Outcomes</label>
                                <Input 
                                    type="number" 
                                    min="1" 
                                    value={exportTopN} 
                                ...
                                {eligibleStudents.length === 0 ? (
                                    ...
                                    <div className="space-y-3">
                                        {eligibleStudents.map((student) => {
                                            ...
                                            // green styling for already assigned students.
                ...
                <DialogContent className="sm:max-w-md rounded-[24px] p-6 text-center border-none shadow-2xl bg-[#E8EEF4]">
                    ...
                    <DialogFooter className="flex sm:justify-center gap-4 border-t border-[#111827]/10 pt-6">
                        ...
                        <Button
                            ...
                            className="bg-red-500 hover:bg-red-600 rounded-full px-10 h-12 font-bold shadow-md transition-all hover:scale-[1.02] text-white"
                        >
                            Yes, Remove
                        </Button>
                    </DialogFooter>
